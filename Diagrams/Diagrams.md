...
4.2 [Добавление нового сотрудника](#4.2)<br>
4.3 [Отправка почтового сообщения](#4.3)<br>
...
##### 1.2.7 Экспорт данных на удаленный источник<a name="1.2.7"></a>
...
##### 1.2.9 Добавление записи о сотруднике<a name="1.2.9"></a>
...
##### 1.2.10 Удаление записи о сотруднике<a name="1.2.10"></a>
...
##### 1.2.11 Редактирование записи о сотруднике<a name="1.2.11"></a>
...
##### 1.2.12 Отправление почтового сообщения<a name="1.2.12"></a>
...
##### 2.9 Добавление записи о сотруднике<a name="2.9"></a>
...
##### 2.10 Удаление записи о сотруднике<a name="2.10"></a>
...
##### 2.11 Редактирование записи о сотруднике<a name="2.11"></a>
...
##### 2.12 Отправление сообщений<a name="2.12"></a>
...
Данные диаграммы были созданы с использованием мокапов:
* Главное окно  https://github.com/EfimSirotkin/SchoolStaffManager/blob/master/Mockups/Main.JPG
* Окно просмотра  https://github.com/EfimSirotkin/SchoolStaffManager/blob/master/Mockups/ViewPage.JPG
* Окно логина  https://github.com/EfimSirotkin/SchoolStaffManager/blob/master/Mockups/LoginPage.png
* Окно регистрации   https://github.com/EfimSirotkin/SchoolStaffManager/blob/master/Mockups/RegistrationPage.png
* Окно отправки сообщений  https://github.com/EfimSirotkin/SchoolStaffManager/blob/master/Mockups/SendMail.JPG
...
##### 4.2 Добавление сотрудника<a name="4.2"></a>
...
##### 4.3 Отправка почтового сообщения<a name="4.3"></a>
